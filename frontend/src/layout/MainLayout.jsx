...
export function MainLayout({ children }) {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50">
            ...
            {/* Footer */}
            <footer className="bg-gradient-to-r from-primary-800 via-primary-900 to-primary-800 border-t-4 border-accent-300/60 mt-12">
                <div className="container py-8">
                    <div className="grid md:grid-cols-3 gap-8 mb-8">
                        <div className="text-white">
                            <h3 className="font-bold text-lg mb-3 text-accent-300">TimeToTask</h3>
                            <p className="text-gray-200 text-sm">Gestor de tareas inteligente para optimizar tu productividad</p>
                        </div>
                        <div className="text-white">
                            <h4 className="font-bold mb-3 text-accent-300">Enlaces</h4>
                            <ul className="space-y-2 text-sm">
                                <li><Link to="/" className="text-gray-200 hover:text-accent-300 transition-colors">Inicio</Link></li>
                                <li><Link to="/dashboard" className="text-gray-200 hover:text-accent-300 transition-colors">Dashboard</Link></li>
                                <li><Link to="/projects" className="text-gray-200 hover:text-accent-300 transition-colors">Proyectos</Link></li>
                            </ul>
                        </div>
                        <div className="text-white">
                            <h4 className="font-bold mb-3 text-accent-300">Contacto</h4>
