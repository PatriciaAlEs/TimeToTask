            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-5 gap-8 mb-12">
                    ...
                    <div className="col-span-1">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="font-display-title text-2xl font-bold text-white light-theme-text">
                                {t('appName')}
                            </span>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-300 light-theme-muted">
                            <li><Link to={devPath(t('features'))}>{t('features')}</Link></li>
                            <li><Link to={devPath(t('pricing'))}>{t('pricing')}</Link></li>
                            <li><Link to={devPath(t('security'))}>{t('security')}</Link></li>
                            <li><Link to={devPath(t('roadmap'))}>{t('roadmap')}</Link></li>
                            <li><Link to={devPath(t('updates'))}>{t('updates')}</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-300 light-theme-muted">
                            <li><Link to={devPath(t('helpCenter'))}>{t('helpCenter')}</Link></li>
                            <li><Link to={devPath(t('documentation'))}>{t('documentation')}</Link></li>
                            <li><Link to={devPath(t('api'))}>{t('api')}</Link></li>
                            <li><Link to={devPath(t('contactUs'))}>{t('contactUs')}</Link></li>
                            <li><Link to={devPath(t('systemStatus'))}>{t('systemStatus')}</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-300 light-theme-muted">
                            <li><Link to={devPath(t('aboutUs'))}>{t('aboutUs')}</Link></li>
                            <li><Link to={devPath(t('blog'))}>{t('blog')}</Link></li>
                            <li><Link to={devPath(t('careers'))}>{t('careers')}</Link></li>
                            <li><Link to={devPath(t('press'))}>{t('press')}</Link></li>
                            <li><Link to={devPath(t('partners'))}>{t('partners')}</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-300 light-theme-muted">
                            <li><Link to={devPath(t('privacy'))}>{t('privacy')}</Link></li>
                            <li><Link to={devPath(t('termsOfService'))}>{t('termsOfService')}</Link></li>
                            <li><Link to="/cookies">{t('cookiesPolicy')}</Link></li>
                            <li><Link to={devPath(t('compliance'))}>{t('compliance')}</Link></li>
                            <li><Link to={devPath(t('licenses'))}>{t('licenses')}</Link></li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-primary-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6 text-sm text-gray-400 light-theme-muted">
                        <Link to={devPath(t('privacy'))}>{t('privacy')}</Link>
                        <Link to={devPath(t('terms'))}>{t('terms')}</Link>
