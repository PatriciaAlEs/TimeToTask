        ...
        <div className="min-h-screen bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700">
            <div className="relative min-h-screen px-4 py-8">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    {/* Header */}
                    <div className="mb-8">
                        <h1 className="text-5xl font-black text-white mb-2 drop-shadow-lg">Sistema de Estilos Base</h1>
                        <p className="text-xl text-gray-100 font-semibold">Referencia completa de componentes reutilizables</p>
                    </div>

                    {/* ===== BOTONES ===== */}
                    <div className="mb-12">
                        <h2 className="text-3xl font-bold text-white mb-4 drop-shadow-lg">Sistema de Botones</h2>
                        <div className="bg-primary-400/30 backdrop-blur-lg rounded-2xl p-6 border border-primary-400/50">
                            <div className="space-y-6">
                                {/* Variantes */}
                                <div>
                                    <h4 className="text-lg font-semibold mb-3 text-white">Variantes</h4>
                                ...
                                {/* Tamaños */}
                                <div>
                                    <h4 className="text-lg font-semibold mb-3 text-white">Tamaños</h4>
                                ...
                                {/* Estados */}
                                <div>
                                    <h4 className="text-lg font-semibold mb-3 text-white">Estados</h4>
                                    <Row gap={2} className="flex-wrap">
                                ...
                                {/* Ancho completo */}
                                <div>
                                    <h4 className="text-lg font-semibold mb-3 text-white">Ancho Completo</h4>
